...
object VoiceLengthHook : SwitchHook("VoiceLengthHook"), IDexFind {
    ...
    private object ValVoiceLength : DefaultData("VoiceLengthHook.voiceLength", intDefVal = 1)
    ...
    override val isAvailable = HostInfo.versionCode > WechatVersion.V8_0_30.code

    override fun initOnce() {
        MethodSetVoice.desc.toAppMethod().hook {
            beforeIfEnabled {
                val obj = args(0).any()!!
