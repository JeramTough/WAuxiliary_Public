...
object AutoLoginWinHook : SwitchHook("AutoLoginWinHook") {
    ...
    override var onClick: ((View) -> Unit)? = { layoutView ->
        ...
        binding.moduleDialogCbAutoSyncMsg.isChecked = ValAutoSyncMsg.booleanVal
        binding.moduleDialogCbShowLoginDevice.isChecked = ValShowLoginDevice.booleanVal
        binding.moduleDialogCbAutoLoginDevice.isChecked = ValAutoLoginDevice.booleanVal
        layoutView.context.showDialog {
            title = funcName
            view = binding.root
            positiveButton("保存") {
                ValAutoSyncMsg.booleanVal = binding.moduleDialogCbAutoSyncMsg.isChecked
                ValShowLoginDevice.booleanVal = binding.moduleDialogCbShowLoginDevice.isChecked
                ValAutoLoginDevice.booleanVal = binding.moduleDialogCbAutoLoginDevice.isChecked
            }
            negativeButton()
        }
    }
    ...
    override fun initOnce() {
        val extDeviceWXLoginUIClass = "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI".toAppClass()
